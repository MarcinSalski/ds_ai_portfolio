...
# Secrets using Streamlit Cloud Mechanics
...
if not st.session_state.get("openai_api_key"):
    if "OPENAI_API_KEY" in env:
        ...
        st.info("Enter your Open AI API Key")
...
add_tab, search_tab = st.tabs(["Add note", "Search"])
with add_tab:
    note_audio = audiorecorder(
        start_prompt="Register note",
        stop_prompt="Stop registering",
    )
    if note_audio:
        audio = BytesIO()
